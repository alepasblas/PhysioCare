...
WORKDIR /usr/src/app
# Copia los archivos que coincidan con el patrón package*.json desde el sistema de archivos del host hasta el directorio de trabajo actual del contenedor
COPY package*.json ./
